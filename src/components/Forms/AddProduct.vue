<template>
  <div>
    <vee-form :validation-schema="addproductschema" class=" md:grid md:grid-cols-3 md:gap-6" @submit="test1">
  ...
  <vee-field name="couponExpiryDate" datepicker type="text" class="focus:ring-indigo-500 focus:border-indigo-500
                      pl-9
                      px-3
                      py-2
                      mb-2
