...
export default {
  ...
  setup() {
    ...
    axios
      .get(process.env.VUE_APP_API_URL + "order/vendor", { withCredentials: true })
      .then((res) => {
        ...
        for (let i = 0; i < maxLength; i++) {
          console.log(products[i].products[0].product.name)
          data1.push({
            id: i,
            quantity:products[i].products[0].quantity,
            name: products[i].products[0].product.name,
            inventory: products[i].products[0].product.inventory,
            description: products[i].products[0].product.description,
            regularPrice: products[i].products[0].product.regularPrice,
            salesPrice: products[i].products[0].product.salesPrice,
            image: products[i].products[0].product.image,
            editUrl:products[i].products[0].product._id,
            status:products[i].products[0].product.status
          });
        }
